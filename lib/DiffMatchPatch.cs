...
//I MODIFIED THIS TO HAVE SOME MORE FEATURES
...
namespace DiffMatchPatch {
  ...
  public class diff_match_patch {
    ...
    public List<Diff> diff_lineMode(string text1, string text2) {//THIS IS NOT ACTUAL GOOGLE CODE. I DID THIS SHIT.
      // Set a deadline by which time the diff must be complete.
      DateTime deadline;
      if (this.Diff_Timeout <= 0) {
        deadline = DateTime.MaxValue;
    ...
    public List<Diff> diff_lineModeStrict(string text1, string text2) {//THIS IS NOT ACTUAL GOOGLE CODE. I DID THIS SHIT.
      // Set a deadline by which time the diff must be complete.
      DateTime deadline;
      if (this.Diff_Timeout <= 0) {
        deadline = DateTime.MaxValue;
      ...
      return diff_lineModeStrict(text1, text2, deadline);
    }

    private List<Diff> diff_lineModeStrict(string text1, string text2, DateTime deadline)//THIS IS NOT ACTUAL GOOGLE CODE. I DID THIS SHIT.
    { 
      var a = this.diff_linesToChars(text1, text2);
      string lineText1 = (string) a[0];
      string lineText2 = (string) a[1];
      List<string> lineArray = (List<string>) a[2];
      var diffs = this.diff_main(lineText1, lineText2, false, deadline);
